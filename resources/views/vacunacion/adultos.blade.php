...
<style>
    .adultos-header-bg {
        background: linear-gradient(135deg, rgba(18, 40, 76, 0.6) 0%, rgba(23, 54, 93, 0.6) 50%, rgba(44, 62, 80, 0.6) 100%), url('{{ asset('reales/real-52.jpeg') }}') center/cover;
        padding: 100px 0;
        position: relative;
        overflow: hidden;
    }
...
<section class="page-header-vacuna adultos-header-bg text-center text-white">
    ...
    <div class="container position-relative z-3 pb-4">
        ...
        <h1 class="display-5 fw-bold mb-3 text-shadow" style="text-shadow: 2px 2px 4px rgba(0,0,0,0.8);">Vacunación para Adultos</h1>
